...
const CategoryProduct = () => {
    ...
    const fetchData = async()=>{
        const response = await fetch(SummaryApi.filterProductt.url, {
            method: SummaryApi.filterProductt.method,
            headers: {
        ...
        // console.log("dataResspoonse",dataResponse);
    }
    ...
    useEffect(()=>{
        ...
        // console.log("SELECTEDcategoryyy",  arrayOfCategory);
                    ...
                    <div className='min-h-[calc(100vh-120px)] overflow-y-scroll max-h-[calc(100vh-120px)]'>
                        {
                            data.length !== 0 && !loading && (
                                <Verticalcardd data={data} loading={loading}/>
                            )
                        }
                    </div>
