...
const CategoryWiseProductDisplay = ({category, heading}) => {
    ...
    return (
        <div className='container mx-auto px-4 my-6 relative bg-white'>
...

                {
                    ...
                    (
                        data.map((product, index)=>{
                            return(
                                <Link to={"/product/"+product?._id} className='w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[300px] bg-white rounded-sm  border'  onClick={scrollTop}>
